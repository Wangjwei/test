...
//            captionFont.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);
            captionFont.setBold(true);// 加粗
...
//            captionStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER);// 左右居中
            captionStyle.setAlignment(HorizontalAlignment.CENTER);// 左右居中
//            captionStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);// 上下居中
            captionStyle.setVerticalAlignment(VerticalAlignment.CENTER);// 上下居中
...
//            explainStyle.setAlignment(HSSFCellStyle.ALIGN_RIGHT);// 左右居中
            explainStyle.setAlignment(HorizontalAlignment.CENTER);// 左右居中
//            explainStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);// 上下居中
            explainStyle.setVerticalAlignment(VerticalAlignment.CENTER);// 上下居中
