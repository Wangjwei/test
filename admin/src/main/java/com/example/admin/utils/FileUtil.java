...
public class FileUtil {
    ...
    /*private static final String PATH = PropertiesUtil.readProperties("UP_DOWN_PATH");
    ...
    public static void downloadFile(String fileName, HttpServletResponse resp) {
        ServletOutputStream outputStream = null;
        try {
            File file = new File(PATH + fileName);
            resp.setContentType("application/octet-stream");
            String newName = new String(fileName.getBytes(StandardCharsets.UTF_8), StandardCharsets.ISO_8859_1);
